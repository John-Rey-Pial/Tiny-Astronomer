    ...
    <div style="display: flex">
      <div style="width: 100%">
        <section class="heading">
          <strong>Question 2 out of 20</strong>
          <strong class="score">Score: {{ this.score }}</strong>
        </section>
        <v-spacer style="margin-bottom: 20px"></v-spacer>
        <div
          class="question"
        >Our local star, a great spinning ball of hot glowing gas that provides light and heat to all the planets in the solar system</div>
        ...
        <div style="margin-left: 530px" v-if="!submitted">
          <v-btn style="text-transform: capitalize" @click="clear">Clear Choice</v-btn>
          <v-btn
